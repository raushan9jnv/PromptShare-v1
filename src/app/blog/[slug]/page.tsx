      ...
      <div className="mx-auto max-w-[1280px] lg:grid lg:grid-cols-[220px_1fr_220px] lg:gap-10 xl:grid-cols-[240px_1fr_240px] xl:gap-14">
        ...
        <article className="min-w-0">
          <header className="rounded-[34px] border border-border-default/80 bg-surface-card/94 p-6 text-center shadow-[0_24px_70px_-48px_rgba(15,23,42,0.28)] sm:p-8">
            ...
            <div className="mt-5 text-sm text-content-muted">
              By <span className="font-medium text-content-secondary">{post.author}</span> · {post.readTime} min read
            </div>
          </header>
          ...
          <div className="mx-auto mt-16 max-w-[760px] border-t border-border-subtle pt-8 text-center text-sm text-content-secondary">
            Found this useful? Browse more in the <a href="/blog" className="text-content-primary underline underline-offset-4 hover:text-accent-600">blog archive</a>.
          </div>
        </article>
