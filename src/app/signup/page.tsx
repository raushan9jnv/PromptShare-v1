...
export default async function SignupPage({
  ...
  return (
    <div className="mx-auto w-full max-w-md px-6 py-12">
      <h1 className="text-2xl font-semibold tracking-tight text-zinc-950">Create account</h1>
      <p className="mt-2 text-sm text-zinc-600">Sign up to post prompts and images.</p>
